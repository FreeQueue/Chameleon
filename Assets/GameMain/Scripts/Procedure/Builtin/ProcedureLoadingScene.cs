...
namespace Chameleon
{
    public class ProcedureLoadingScene : ProcedureBase
    {
        ...
        private int? m_UILoadFormSerialID;
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                Type procedureType = Type.GetType(string.Format("Chameleon.{0}", sceneData.Procedure));
        ...
        private void OnLoadSceneSuccess(object sender, GameEventArgs e)
        {
            ...
            GameEntry.Event.Fire(this, LoadSceneFinishEventArgs.Create(loadingSceneId));
